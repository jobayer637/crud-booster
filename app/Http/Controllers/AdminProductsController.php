...
use Session;
	...
	class AdminProductsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Category Name","name"=>"category_id","join"=>"categories,name"];
			...
			$this->form = [];
			//$this->form[] = ['label'=>'User','name'=>'user_id','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'users,name'];
			$this->form[] = ['label'=>'Category','name'=>'category_id','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'categories,name'];
	    ...
	    */
        ...
        public function getProducts() {
            ...
            ->get();
            return view('product', compact('data','category'));
        }
