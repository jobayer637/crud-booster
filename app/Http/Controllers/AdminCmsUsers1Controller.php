<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "Product Category";
			$this->limit = "20";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Name","name"=>"name","width"=>"10"];
			$this->col[] = ["label"=>"Slug","name"=>"slug","width"=>"10"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			$this->form[] = ['label'=>'Slug','name'=>'slug','type'=>'text','validation'=>'required|max:70|string','width'=>'col-sm-10'];
